...
if __name__ == '__main__':
    ...
    # GDAL variables
    gdal.SetConfigOption(str('GDAL_DATA'), str(path.realpath(r'../../data/gdal')))
    # test files
    li_gml = [path.realpath(r'..\..\test\datatest\vectors\gml\airports.gml')]
    ...
    for gml in li_gml:
        ...
        logging.info(gml)
        info_gml = ReadGML(path.abspath(gml),
                           dico_layer,
                           dico_fields,
                           'GML',
                           textos)
