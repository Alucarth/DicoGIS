...
from ttk import Checkbutton, Entry, Frame, Label
...
class TabSettings(Frame):
    def __init__(self, parent, txt=dict(), switcher=None):
        ...
        self.FrOptIsogeo.grid(
            row=3, column=1, columnspan=8, sticky="NSWE", padx=2, pady=2, rowspan=4
        )
        ...
        isog_ent_id.grid(row=1, column=2, columnspan=2, sticky="NSEW", padx=2, pady=2)
        isog_lb_tk.grid(row=2, column=1, sticky="NSEW", padx=2, pady=2)
        isog_ent_tk.grid(row=2, column=2, columnspan=2, sticky="NSEW", padx=2, pady=2)
